...
function letterCombinations(digits: string): string[] {
    ...
    var lettersList = new Array<string[]>(digits.length);
    ...
    var result: string[] = lettersList[0];
    var previous: string[] = lettersList[0];
    ...
    for (let cursor = 1; cursor < lettersList.length; cursor++) {
        ...
        result = new Array<string>(previous.length * current.length);
        var p = 0;
...
expect(letterCombinations("23")).to.only.includes(["ad", "ae", "af", "bd", "be", "bf", "cd", "ce", "cf"]);
